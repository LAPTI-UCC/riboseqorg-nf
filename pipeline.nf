...
process rRNA_mapping {
	...
	"""
	bowtie -p 8 -v 3 --norc --phred33-qual $params.rRNA_index -q ${clipped_fastq} --un ${clipped_fastq.baseName}_less_rRNA.fastq > ${params.study_dir}/${clipped_fastq.baseName}_rRNA_stats.txt 2>&1
	"""
}
